...
;
/**
 * @typedef LoggedInData
 * @type {Object}
 * @property {string} identifier - identifier
 * @property {string} password - password
 */
/**
 * @typedef LoggedInRequestConfig
 * @type {Object}
 * @property {LoggedInrData} data - body of the request
 */
/**
 * @param {LoggedInRequestConfig & Object<string,any>} config
 * @returns {Promise<any>}
 */
export function logged(config) {
    config = { ...config, method: "get", url: "https://master.spicaengine.com/api/fn-execute/logged" };
